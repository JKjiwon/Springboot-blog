package com.jwsoft.blog.config;

import com.jwsoft.blog.config.auth.PrincipalDetailService;
...
@EnableWebSecurity // 시큐리티 필터 추가 = 시큐리티 필터가 등록이 된다.
